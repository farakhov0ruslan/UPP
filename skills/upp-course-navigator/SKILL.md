...
4. Read the active seminar card/slides, the matching lecture, `Кейс`, `00_Старт_студента_Москва_8.1.pdf`, and the assessment rules.
5. Separate official course instructions from a newer deadline or clarification supplied by the user. State conflicts explicitly.
6. Report exact locations: workbook, sheet, answer blocks/ranges, export format, folder, form, and optional fields.
